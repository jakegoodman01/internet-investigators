        ...
        b.setOnAction(e -> {
            if (textField.getCharacters().length() != 0) {
                if (textField.getCharacters().toString().indexOf('%') != -1) {
                    ...
                    Photo reasonButton;
                    Photo[] windows = {new Photo("screens/reasons/reason1.png"),
                            new Photo("screens/reasons/reason2.png"),
                            new Photo("screens/reasons/reason3.png"),
                            new Photo("screens/reasons/reason4.png"),
                            new Photo("screens/reasons/reason5.png"),
                            new Photo("screens/reasons/reason6.png")};
                    for (int i = 0; i<6; i++)
                    {
